...
const person =[
  {
    ...
    name:"James Anderson",
    position: "Facebook, Product Leads"
  }
]
...
<template>
  <div class="untree_co-section" id="features-section">
    <div class="container">
      <div class="row justify-content-between">
        <div class="col-lg-4">
          <span class="caption" data-aos="fade-up" data-aos-delay="0"
            ...
            <div class="untree_co-testimonial d-flex">
              <div class="text">
                ...
                <div class="author d-flex">
                  ...
                  <div>
                    <strong class="d-block">{{person[0].name}}</strong
                    ><span class="d-block">{{ person[0].position }}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-7" data-aos="fade-up" data-aos-delay="400">
          ...
          >
            ...
            <img
              src="/frontend/images/dashboard.jpg"
              alt="Image"
  ...
  <div class="untree_co-section">
    <div class="container">
      ...
      <div v-for="(item, index) in allServices" :key="index"
          class="col-md-6 mb-4 mb-lg-0 col-lg-3"
          data-aos="fade-up"
          data-aos-delay="0">
          <div class="service">
            <div class="service-icon mb-4" :class="item.iconColor">
              <svg
                class="bi bi-app-indicator"
                width="1em"
                height="1em"
